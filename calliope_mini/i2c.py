...
class MicroBitI2C:
    ...
    def init(self: "MicroBitI2C", freq: int = 100000, sda: int = c18, scl: int = c19) -> None:
    ...
    def read(self: "MicroBitI2C", addr: int, n: int, repeat: bool = False) -> bytes:
    ...
    def write(self: "MicroBitI2C", addr: int, buf: Union[bytes, bytearray], repeat=False) -> None:
