...
class MicroBitUART:
    ...
    def init(self: "MicroBitUART",
        ...
        and it can be ``None``, ``uart.ODD`` or ``uart.EVEN``.
        The ``stop`` parameter tells the number of stop bits
        (Note: It may not work if this parameter is other than 1.)
    ...
    def readinto(self: "MicroBitUART", buf: bytearray, nbytes: int = None) -> Optional[int]:
    ...
    def readline(self: "MicroBitUART", max_size: int = None) -> Optional[bytes]:
    ...
    @overload
    def write(self: "MicroBitUART", buf: Union[str, bytes, bytearray], offset: int = None, length: int = None) -> Optional[int]:
        ...

    @overload
    def write(self: "MicroBitUART", buf: Union[str, bytes, bytearray], length: int = None) -> Optional[int]:
        ...
